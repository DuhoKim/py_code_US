...
hgrps=fits.open('/Users/dhk/work/data/NGC_IC/pilot4/gr.pp.sub.160.1.fits')
...
s.set_xlim(-0.1,0.5)
s.set_ylim(0,4)
s.text(-0.08,3.6,'160x160 pixels')
...
fig.savefig("/Users/dhk/work/data/NGC_IC/pilot4/plot_grp160_mask_Jarret_psfsize.pdf")
