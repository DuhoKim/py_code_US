...
work_dir = data_dir+'g_bench2/'
psf_dir = data_dir+'g_psf2'
...
num_psf_stars = 50      # Number of PSF stars
...
iraf.findpars.threshold = 25.0           # Threshold in sigma for feature detection (default=4.0)
