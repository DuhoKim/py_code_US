...
h1.plot(np.arange(0., 3., 0.1), np.nanmean(av_prof_E[:, int(min_idx[0]), :], axis=0), color=cols_for_bv0s[4], linewidth=3)
h2.plot(np.arange(0., 3., 0.1), np.nanmean(av_prof_S0[:, int(min_idx[1]), :], axis=0), color=cols_for_bv0s[4], linewidth=3)
h3.plot(np.arange(0., 3., 0.1), np.nanmean(av_prof_Sa[:, int(min_idx[2]), :], axis=0), color=cols_for_bv0s[4], linewidth=3)
h4.plot(np.arange(0., 3., 0.1), np.nanmean(av_prof_Sb[:, int(min_idx[3]), :], axis=0), color=cols_for_bv0s[4], linewidth=3)
h5.plot(np.arange(0., 3., 0.1), np.nanmean(av_prof_Sbc[:, int(min_idx[4]), :], axis=0), color=cols_for_bv0s[4], linewidth=3)
h6.plot(np.arange(0., 3., 0.1), np.nanmean(av_prof_Sc[:, int(min_idx[5]), :], axis=0), color=cols_for_bv0s[4], linewidth=3)
h7.plot(np.arange(0., 3., 0.1), np.nanmean(av_prof_Sd[:, int(min_idx[6]), :], axis=0), color=cols_for_bv0s[4], linewidth=3, label=r'$\beta_{V}$ method')

h1.fill_between(np.arange(0, 3, 0.1), np.nanmean(av_prof_E[:, int(min_idx[0]), :], axis=0) - np.nanstd(av_prof_E[:, int(min_idx[0]), :], axis=0),
    np.nanmean(av_prof_E[:, int(min_idx[0]), :], axis=0) + np.nanstd(av_prof_E[:, int(min_idx[0]), :], axis=0), alpha=alcalfill, color=cols_for_bv0s[4])
h2.fill_between(np.arange(0, 3, 0.1), np.nanmean(av_prof_S0[:, int(min_idx[1]), :], axis=0) - np.nanstd(av_prof_S0[:, int(min_idx[1]), :], axis=0),
    np.nanmean(av_prof_S0[:, int(min_idx[1]), :], axis=0) + np.nanstd(av_prof_S0[:, int(min_idx[1]), :], axis=0), alpha=alcalfill, color=cols_for_bv0s[4])
h3.fill_between(np.arange(0, 3, 0.1), np.nanmean(av_prof_Sa[:, int(min_idx[2]), :], axis=0) - np.nanstd(av_prof_Sa[:, int(min_idx[2]), :], axis=0),
    np.nanmean(av_prof_Sa[:, int(min_idx[2]), :], axis=0) + np.nanstd(av_prof_Sa[:, int(min_idx[2]), :], axis=0), alpha=alcalfill, color=cols_for_bv0s[4])
h4.fill_between(np.arange(0, 3, 0.1), np.nanmean(av_prof_Sb[:, int(min_idx[3]), :], axis=0) - np.nanstd(av_prof_Sb[:, int(min_idx[3]), :], axis=0),
    np.nanmean(av_prof_Sb[:, int(min_idx[3]), :], axis=0) + np.nanstd(av_prof_Sb[:, int(min_idx[3]), :], axis=0), alpha=alcalfill, color=cols_for_bv0s[4])
h5.fill_between(np.arange(0, 3, 0.1), np.nanmean(av_prof_Sbc[:, int(min_idx[4]), :], axis=0) - np.nanstd(av_prof_Sbc[:, int(min_idx[4]), :], axis=0),
    np.nanmean(av_prof_Sbc[:, int(min_idx[4]), :], axis=0) + np.nanstd(av_prof_Sbc[:, int(min_idx[4]), :], axis=0), alpha=alcalfill, color=cols_for_bv0s[4])
h6.fill_between(np.arange(0, 3, 0.1), np.nanmean(av_prof_Sc[:, int(min_idx[5]), :], axis=0) - np.nanstd(av_prof_Sc[:, int(min_idx[5]), :], axis=0),
    np.nanmean(av_prof_Sc[:, int(min_idx[5]), :], axis=0) + np.nanstd(av_prof_Sc[:, int(min_idx[5]), :], axis=0), alpha=alcalfill, color=cols_for_bv0s[4])
h7.fill_between(np.arange(0, 3, 0.1), np.nanmean(av_prof_Sd[:, int(min_idx[6]), :], axis=0) - np.nanstd(av_prof_Sd[:, int(min_idx[6]), :], axis=0),
    np.nanmean(av_prof_Sd[:, int(min_idx[6]), :], axis=0) + np.nanstd(av_prof_Sd[:, int(min_idx[6]), :], axis=0), alpha=alcalfill, color=cols_for_bv0s[4])
...
h1.text(0.3,0.85,'E',size=20)
h2.text(0.3,0.85,'S0',size=20)
h3.text(0.3,0.85,'Sa',size=20)
h4.text(0.3,0.85,'Sb',size=20)
h5.text(0.3,0.85,'Sbc',size=20)
h6.text(0.3,0.85,'Sc',size=20)
h7.text(0.3,0.85,'Sd',size=20)

h1.text(0.3,0.65,'N=%d' % cnt_E,size=15, color=cols_for_bv0s[4])
h2.text(0.3,0.65,'N=%d' % cnt_S0,size=15, color=cols_for_bv0s[4])
h3.text(0.3,0.65,'N=%d' % cnt_Sa,size=15, color=cols_for_bv0s[4])
h4.text(0.3,0.65,'N=%d' % cnt_Sb,size=15, color=cols_for_bv0s[4])
h5.text(0.3,0.65,'N=%d' % cnt_Sbc,size=15, color=cols_for_bv0s[4])
h6.text(0.3,0.65,'N=%d' % cnt_Sd,size=15, color=cols_for_bv0s[4])
h7.text(0.3,0.65,'N=%d' % cnt_Sd,size=15, color=cols_for_bv0s[4])

h1.text(0.3,0.75,r'$\beta_{V,0}$=0.5',size=15, color=cols_for_bv0s[4])
h2.text(0.3,0.75,r'$\beta_{V,0}$=0.6',size=15, color=cols_for_bv0s[4])
h3.text(0.3,0.75,r'$\beta_{V,0}$=0.73',size=15, color=cols_for_bv0s[4])
h4.text(0.3,0.75,r'$\beta_{V,0}$=0.73',size=15, color=cols_for_bv0s[4])
h5.text(0.3,0.75,r'$\beta_{V,0}$=0.81',size=15, color=cols_for_bv0s[4])
h6.text(0.3,0.75,r'$\beta_{V,0}$=0.85',size=15, color=cols_for_bv0s[4])
h7.text(0.3,0.75,r'$\beta_{V,0}$=0.97',size=15, color=cols_for_bv0s[4])

h4.set_ylabel(r'$A_{V}$',size=20)
h5.set_xlabel(r'$R/R_{50,V}^{P}$',size=20)
h6.set_xlabel(r'$R/R_{50,V}^{P}$',size=20)
h7.set_xlabel(r'$R/R_{50,V}^{P}$',size=20)
...
h4.tick_params(labelsize='large',direction='in',top=True,right=True,bottom=True,left=True)
h5.tick_params(labelsize='large',direction='in',top=True,right=True,bottom=True,left=True)
h6.tick_params(labelsize='large',direction='in',top=True,right=True,bottom=True,left=True)
h7.tick_params(labelsize='large',direction='in',top=True,right=True,bottom=True,left=True)

h7.legend(bbox_to_anchor=(1.015, 0.35), prop={'size': 20})
...
#h7.text(3.5,0.6,r'$\beta_{V}$ = f$_V$/f$_{3.6\mu m}$ \n $\beta_{V,0}$ = f$_V$/f$_{3.6\mu m}$ (A$_V$=0) \n A$_V$ = 2.5 x log($\beta_{V,0}$/$\beta_{V}$)')

h7.text(3.5,0.55,r'A$_V$ $\cong$ 2.5 x $\log \left( \frac{\beta_{V,0} (f_{V,0}/f_{3.6\mu m,0})}{\beta_{V} (f_V/f_{3.6\mu m})} \right)$', size=25)

fig.savefig('/Users/dhk/Documents/publish/ngcic/dust_prof_all_T_Rogier.ps')
plt.close(fig)
