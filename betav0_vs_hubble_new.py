...
hubble_bv0_err_h = [0.01, 0.02, 0.04, 0.04, 0.04, 0.03, 0.11]
hubble_bv0_err_l = [0.02, 0.01, 0.03, 0.04, 0.04, 0.04, 0.13]
...
plt.errorbar(hubble_coords, hubble_bv0, yerr=[hubble_bv0_err_l, hubble_bv0_err_h], fmt='o')
...
fig.savefig('/Users/dhk/Documents/publish/ngcic_rev/betav0_hubble_new.pdf')
