...
h1 = fig.add_axes([ 0.15,    0.15,   0.8,  0.8])
...
h1.set_ylabel(r'log(Z/Z$_{\odot}$)', fontsize=15)
h1.set_xlim([0, 7])
h1.set_ylim(0,1.0)
...
#                         Line2D([0],[0],color='red', alpha=0.5, linewidth=3, linestyle=':')   ]
custom_lines5 = [       Line2D([0],[0],color='red', linestyle='-',  linewidth=3),
...
fig.savefig('/Users/dhk/Documents/publish/ngcic/Zevol_SFH.pdf')
plt.close(fig)