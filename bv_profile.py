...
av_prof_sfh3 = np.zeros((84,50))	# For stacking Dust profiles for SFH3 w/ 6 Zs
av_prof_sfh4 = np.zeros((90,50))        # For stacking Dust profiles for SFH4 w/ 6 Zs
av_prof_sfh41 = np.zeros((90,50))        # For stacking Dust profiles for SFH4 w/ 6 Zs with B/T < 0.5
av_prof_sfh42 = np.zeros((90,50))        # For stacking Dust profiles for SFH4 w/ 6 Zs with B/T > 0.5
av_prof_sfh5 = np.zeros((60,50))        # For stacking Dust profiles for SFH5 w/ 6 Zs
av_prof_sfh51 = np.zeros((60,50))        # For stacking Dust profiles for SFH5 w/ 6 Zs with B/T < 0.5
av_prof_sfh52 = np.zeros((60,50))        # For stacking Dust profiles for SFH5 w/ 6 Zs with B/T > 0.5
...
#for x in range(0,1):
	...
	ell1=ascii.read(work_dir+'ellipse/pa_ellip/'+name+'_bv.txt')
...
alsfhfill=0.1
h1.plot(np.arange(0.,5.,0.1),np.nanmean(av_prof_sfh3[:,:],axis=0),alpha=alsfhline)	
h1.fill_between(np.arange(0.,5.,0.1),np.nanmean(av_prof_sfh3[:,:],axis=0)-np.nanstd(av_prof_sfh3[:,:],axis=0), \
...
h2.plot(np.arange(0.,5.,0.1),np.nanmean(av_prof_sfh4[:cnt_sfh4,:],axis=0),alpha=alsfhline)	
h2.fill_between(np.arange(0.,5.,0.1),np.nanmean(av_prof_sfh4[:cnt_sfh4,:],axis=0)-np.nanstd(av_prof_sfh4[:cnt_sfh4,:],axis=0), \
	np.nanmean(av_prof_sfh4[:cnt_sfh4,:],axis=0)+np.nanstd(av_prof_sfh4[:cnt_sfh4,:],axis=0),alpha=alsfhfill)
...
h21.plot(np.arange(0.,5.,0.1),np.nanmean(av_prof_sfh41[:cnt_sfh41,:],axis=0),alpha=alsfhline)
h21.fill_between(np.arange(0.,5.,0.1),np.nanmean(av_prof_sfh41[:cnt_sfh41,:],axis=0)-np.nanstd(av_prof_sfh41[:cnt_sfh41,:],axis=0), \
	np.nanmean(av_prof_sfh41[:cnt_sfh41,:],axis=0)+np.nanstd(av_prof_sfh41[:cnt_sfh41,:],axis=0),alpha=alsfhfill)

h22.plot(np.arange(0.,5.,0.1),np.nanmean(av_prof_sfh42[:cnt_sfh42,:],axis=0),alpha=alsfhline)
h22.fill_between(np.arange(0.,5.,0.1),np.nanmean(av_prof_sfh42[:cnt_sfh42,:],axis=0)-np.nanstd(av_prof_sfh42[:cnt_sfh42,:],axis=0), \
	np.nanmean(av_prof_sfh42[:cnt_sfh42,:],axis=0)+np.nanstd(av_prof_sfh42[:cnt_sfh42,:],axis=0),alpha=alsfhfill)

h3.plot(np.arange(0.,5.,0.1),np.nanmean(av_prof_sfh5[:cnt_sfh5,:],axis=0),alpha=alsfhline)	
h3.fill_between(np.arange(0.,5.,0.1),np.nanmean(av_prof_sfh5[:cnt_sfh5,:],axis=0)-np.nanstd(av_prof_sfh5[:cnt_sfh5,:],axis=0), \
...
h31.plot(np.arange(0.,5.,0.1),np.nanmean(av_prof_sfh51[:cnt_sfh51,:],axis=0),alpha=alsfhline)
h31.fill_between(np.arange(0.,5.,0.1),np.nanmean(av_prof_sfh51[:cnt_sfh51,:],axis=0)-np.nanstd(av_prof_sfh51[:cnt_sfh51,:],axis=0), \
	np.nanmean(av_prof_sfh51[:cnt_sfh51,:],axis=0)+np.nanstd(av_prof_sfh51[:cnt_sfh51,:],axis=0),alpha=alsfhfill)

h32.plot(np.arange(0.,5.,0.1),np.nanmean(av_prof_sfh52[:cnt_sfh52,:],axis=0),alpha=alsfhline)
h32.fill_between(np.arange(0.,5.,0.1),np.nanmean(av_prof_sfh52[:cnt_sfh52,:],axis=0)-np.nanstd(av_prof_sfh52[:cnt_sfh52,:],axis=0), \
...
fig.savefig('/Users/dhk/Documents/publish/ngcic/figs/bv_prof_all.pdf')
plt.close(fig)
