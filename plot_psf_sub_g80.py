...
hgrp=fits.open('/Users/dhk/work/data/NGC_IC/pilot4/g.r.pp.80.fits')
hgrps=fits.open('/Users/dhk/work/data/NGC_IC/pilot4/g.r.pp.80.sub.1.fits')
...
h.text(-0.4,800,'g_r_p_D80-I1_PSF_D80')
h.set_xlim(-0.5,0.5)
...
fig.savefig("/Users/dhk/work/data/NGC_IC/pilot4/plot_grp80.pdf")
