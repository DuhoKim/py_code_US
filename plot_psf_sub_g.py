...
box_size=15
n=10	# a threshold throttle (with satisfactory values between 5 and 10) Jarrett et al. 2003

hgrp=fits.open('/Users/dhk/work/data/NGC_IC/pilot4/g.r.p.fits')
hgrps=fits.open('/Users/dhk/work/data/NGC_IC/pilot4/g.r.p.sub.1.fits')
hgpsf=fits.open('/Users/dhk/work/data/NGC_IC/pilot4/g.r.psf.1.out.fits')
hipsf=fits.open('/Users/dhk/work/data/NGC_IC/pilot4/i1.psf.1.out.fits')
...
h.text(-0.4,800,'g_r_p_D17-I1_PSF_D17')
h.set_xlim(-0.5,0.5)
...
for i in range(0,30):
	...
	a2.imshow(np.sqrt(np.log(1+thumbs/(n*np.std(thumbs)))), cmap='gray_r')
...
fig.savefig("/Users/dhk/work/data/NGC_IC/pilot4/plot_grp17_mean.pdf")
